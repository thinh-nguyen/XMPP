...
//                    }
    ...
    public void sendBroadcast(Map<String, String> payload, String collapseKey,
            long timeToLive, Boolean delayWhileIdle, List<String> recipients, Map<String, String> notification) {
    ...
    public static String createJsonMessage(String to, String messageId, Map<String, String> payload,
            String collapseKey, Long timeToLive, Boolean delayWhileIdle, Map<String, String> notification) {
        return createJsonMessage(createAttributeMap(to, messageId, payload,
                collapseKey, timeToLive, delayWhileIdle, notification));
    }
...
//        config.setSendPresence(false);
    ...
    public static void main(String[] args) {
        final String projectId = "325484363354";//"meltwater-mobile-e99f0";//"1:650997755432:ios:e310be9836d711a4";//args[0];
        final String password = "AIzaSyDjoX0pkg-oROzLbCyAJLSqkvKYColb4Z4";//"AIzaSyBkjQ0E9v7vF5wEjiXQpXMNIUELpDYr_r0"; //args[1];
        final String toRegId = "fQaCVa4fd-c:APA91bHLmfrn7H-0Os0k7dQh76tZHfiyMm3uB38DW9X5fnwt6VG4WKbmbEGT8XJCMfINnqZQTfXSeIIE8EWC0RYMDpz5qXk4S1vVeoQXtb6dbnqDAZCCrUtOoVR66z2-0jL8vuNPiFqY";//args[2];
